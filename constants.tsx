...
export const LENGTH_OPTIONS = [
  { label: '100 Words (~1 min)', words: 100, mins: 1 },
  { label: '750 Words (~5 min)', words: 750, mins: 5 },
  { label: '1500 Words (~10 min)', words: 1500, mins: 10 },
  { label: '2000 Words (~15 min)', words: 2000, mins: 15 },
  { label: '3000 Words (~20 min)', words: 3000, mins: 20 },
];

export const CHANNEL_PRESETS = [
  { id: 'Luxury', name: 'Luxury Brand', description: 'Sophisticated, high-end, aspirational' },
  { id: 'Travel', name: 'Travel & Lifestyle', description: 'Energetic, evocative, inspiring' },
  { id: 'Self-Help', name: 'Spirituality & Meditation', description: 'Calm, profound, guiding' },
];
...
export const ICONS = {
  ...
  Idea: (props: any) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .5 2.2 1.5 3.1.7.7 1.3 1.5 1.5 2.5"/><line x1="9" y1="18" x2="15" y2="18"/><line x1="10" y1="22" x2="14" y2="22"/></svg>
  ),
  Search: (props: any) => (
  ...
  Folder: (props: any) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
  ),
  Mic: (props: any) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/></svg>
  )
};
